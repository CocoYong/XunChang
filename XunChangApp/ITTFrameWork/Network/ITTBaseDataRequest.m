...
- (NSDictionary*)getStaticParams
{
    ...
    NSRange range = [[self getRequestUrl]rangeOfString:@".com"];
    NSString *uri = [[self getRequestUrl]substringFromIndex:range.length+range.location];
    uri = [uri stringByReplacingOccurrencesOfString:@"?" withString:@""];
    [staticparam setObject:DYAppid forKey:@"appid"];
    [staticparam setObject:uri forKey:@"_URI_"];
    return staticparam;
}
