...
- (void)generateRequestWithUrl:(NSString*)url withParameters:(NSDictionary*)params
{
    ...
    [_requestOperation setCompletionBlockWithSuccess:
     ^(AFHTTPRequestOperation *operation, id responseObject) {
         [weakSelf handleResponseString:operation.responseString];
...
- (void)doRequestWithParams:(NSDictionary*)params
{
    ...
    [paramsall addEntriesFromDictionary:params];
    [paramsall addEntriesFromDictionary:[self getStaticParams]];
    
    DYEncryptionResult *result = [DYEncryptionManager encryptionWithURL:self.requestUrl parameters:paramsall];
    [self generateRequestWithUrl:result.url withParameters:result.param];
